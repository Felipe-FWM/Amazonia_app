...
children: [
Text(
details['especies/$especieId']['nome'] ?? 'Nome não encontrado',
style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold),
),
SizedBox(height: 16),
Text(details['descricoes-botanicas/$especieId']?['descricao'] ?? ''),
SizedBox(height: 16),
Text('Biologia Reprodutiva:'),
Text(details['biologias-reprodutivas/$especieId']?['descricao'] ?? ''),
SizedBox(height: 16),
